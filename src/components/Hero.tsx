  ...
  return (
    <section className="relative min-h-[calc(100vh-64px)] flex items-center py-12 px-6 md:px-16 overflow-hidden">
      ...
      <div className="w-full relative z-10 grid grid-cols-12">
        ...
        >
          <div className="mb-8">
            <span className="text-[var(--color-accent)] text-[11px] font-bold tracking-widest font-mono">
              00 / HERO
            </span>
          </div>
          ...
          >
            ...
            work revolves around creating infrastructure, frameworks and editors
            that help developers build better software.
          </motion.p>
          ...
          >
            <a
              href="#work"
              className="px-8 py-3 border border-white/10 hover:border-white/40 transition-all text-[11px] tracking-[0.3em] uppercase bg-white/5 font-bold hover:bg-white/10 relative overflow-hidden group"
            >
              <span className="relative z-10 transition-transform duration-500 group-hover:translate-x-1 inline-block">
                Explore Work
              </span>
            </a>
            <div className="flex flex-col">
              ...
              <span className="text-[11px] font-mono mt-1 opacity-70">
                Open Source / Engines / Desktop / AI [●]
              </span>
            </div>
          </motion.div>
        </motion.div>
